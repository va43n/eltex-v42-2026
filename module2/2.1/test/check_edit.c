...
START_TEST(check_edit_1) {
  ...
  ck_assert_int_eq(phone_book_edit(head->next, EDIT_FULL_NAME, NAME2), SUCCESS);
  ck_assert_int_eq(phone_book_edit(head->next, EDIT_JOB_PLACE, JOB_PLACE2),
                   SUCCESS);
  ck_assert_int_eq(
      phone_book_edit(head->next, EDIT_JOB_POSITION, JOB_POSITION2), SUCCESS);

  ck_assert_int_eq(
      phone_book_edit(head->next, EDIT_NUMBERS | EDIT_NUMBERS_ADD, NUMBER3),
      SUCCESS);
  ck_assert_int_eq(
      phone_book_edit(head->next, EDIT_NUMBERS | EDIT_NUMBERS_ADD, NUMBER4),
      SUCCESS);
  ...
  ck_assert_int_eq(
      phone_book_edit(head->next, EDIT_SOCIALS | EDIT_SOCIALS_ADD, social1),
      SUCCESS);
  ck_assert_int_eq(
      phone_book_edit(head->next, EDIT_SOCIALS | EDIT_SOCIALS_ADD, social2),
      SUCCESS);

  ck_assert_int_eq(phone_book_edit(head->next, EDIT_OTHER, OTHER2), SUCCESS);
  ...
  ck_assert_int_eq(phone_book_edit(head->next, EDIT_NUMBERS, 10), ERROR);

  ck_assert_int_eq(phone_book_edit(head->next, EDIT_NUMBERS, 0), SUCCESS);
  ...
  ck_assert_int_eq(phone_book_edit(head->next, EDIT_SOCIALS, 10), ERROR);

  ck_assert_int_eq(phone_book_edit(head->next, EDIT_SOCIALS, 0), SUCCESS);
