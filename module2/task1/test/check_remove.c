...
START_TEST(check_remove_2) {
  ...
  USER_3(NAME3, JOB_PLACE2, JOB_POSITION1, OTHER4, &result);
  ck_assert_int_eq(result, SUCCESS);
  USER_3(NAME3, JOB_PLACE2, JOB_POSITION1, OTHER5, &result);
  ck_assert_int_eq(result, SUCCESS);
  USER_3(NAME3, JOB_PLACE2, JOB_POSITION1, OTHER6, &result);
  ck_assert_int_eq(result, SUCCESS);
  ...
  ck_assert_int_eq(strcmp(head->next->next->other, OTHER5), 0);
  ck_assert_int_eq(strcmp(head->next->next->next->other, OTHER4), 0);
